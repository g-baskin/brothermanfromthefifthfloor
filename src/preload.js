...
contextBridge.exposeInMainWorld("brah", {
  ...
  getMobileBridgeStatus: () => ipcRenderer.invoke("mobile:get-status"),
  getMobilePairingQr: () => ipcRenderer.invoke("mobile:get-pairing-qr"),
  startMobilePairing: () => ipcRenderer.invoke("mobile:start-pairing"),
  stopMobilePairing: () => ipcRenderer.invoke("mobile:stop-pairing"),
  listMobileDevices: () => ipcRenderer.invoke("mobile:list-devices"),
  deleteMobileDevice: (deviceId) => ipcRenderer.invoke("mobile:delete-device", deviceId),
